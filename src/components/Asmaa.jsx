...
const Asmaa = () => {
  ...
  // Pagination: Calculer les pages à afficher
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#F6F4ED]">
        ...
        {/* Pagination avec "Page X sur Y" */}
        <div className="flex justify-center mt-8 items-center space-x-4 pb-10">
          {/* Bouton Précédent */}
          <button
            onClick={() => paginate(currentPage - 1)}
            disabled={currentPage === 1}
            className="bg-[#cbd5e1] text-gray-800 px-4 py-2 rounded-md disabled:opacity-50 "
          >
            Prev
          </button>
